...
<body>
    <div id="app">
        ...
        <div id="main">
            ...
            <form class="main-content container-fluid" method = 'post' action = 'progcoor-loadsubjects.php'>
                <section class="section">
                <div class="card">
						<div class="card-header" style="background-color: #3365c1; color:white"><strong><center>List of Student Information</center></strong></div>
						<?php
