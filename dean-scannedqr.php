            ...
            <div class="main-content container-fluid">
                <div class="page-title">
                    <div class='row'>
                        ...
                        <div class = 'col-md-6' style = 'border:solid; border-color:#3365c1'>
                ...
                <section class="section">
                    <form class="row mb-4" method='post'>
                                ...
                                <div class='card-body'>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-12">
                                            <p style='font-size:18px'><strong>Name: </strong><?php echo $_SESSION['slastname'] ?>, <?php echo $_SESSION['sfirstname'] ?> <?php echo substr($_SESSION['smiddlename'], 0, 1) ?></p>
                                        </div>
                                    </div>
                        ...
                        <div class = 'col-md-6' style='position:relative'>
                            <div class="card-header" style="background-color: #3365c1; color:white"><strong><center>Student List of Attendance</center></strong></div>
                            <?php
                                ...
                                <table id="myTable" class="table table-bordered table-sm" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><?php  echo $row['firstname']; ?>, <?php  echo $row['lastname']; ?> <?php  echo $m; ?></td>
