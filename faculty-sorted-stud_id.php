                    ...
                    <div class = 'col-md-12'>
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <p class="col-md-12 col-12" style='font-size:18px'><b>Last name: </b><?php echo $_SESSION['slastname']; ?>, <?php echo $_SESSION['sfirstname']; ?> <?php echo substr($_SESSION['smiddlename'], 0, 1); ?>.</p>
                                </div>
                                <br>
                            </div>
                        </div>
