...
<head>
    ...
    <title>Sign up - Rizal Technological University</title>
                        ...
                        <div class="card pt-4">
                            <div class="card-body">
                                <div class="text-center mb-5">
                                    <img src="assets\images\background\RTU LOGO.png" height="80" class='mb-4'>
                                    <h3>Sign Up</h3>
                                ...
                                <form action="dean-createacc.php" method="POST">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-12">
                                            <div class="dropdown">
                                                <Select class="body_text" name="accesslevel" id='SelectedSection'>
                                                    <option value="Please Select"> SELECT ACCESS LEVEL </option>
                                    ...
                                    ?>
                                    <div class="clearfix">
                                        <input onclick="myFunction()" type="submit" name="deanRegister" value="SIGN UP" class="btn btn-primary float-end" style="margin-right: 200px;">
                                    </div>
                                    <br>
                                </form>
                            </div>
