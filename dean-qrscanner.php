    ...
    <div id="app">
        <div id="sidebar" class='active'>
            <div class="sidebar-wrapper active">
                <center>
                    <div class="sidebar-header" style="background-color: #3365c1">
                        <img src="assets\images\background\RTU LOGO.png">
                        <br>
                        <a style="color:white;font-size:22px;">Rizal Tecchnological University</a>
                    </div>	
                </center>
                    ...
                    <ul class="menu">
                        ...
                        <li class="sidebar-item  has-sub">
                            <a href="#" class='sidebar-link' style="background-color: #e3e3e3">
                                ...
                                <span>Faculty Account Option</span>
                            </a>
                            <ul class="submenu " style="background-color: #e3e3e3">
                                <li>
                                    <a href="dean-createacc.php">Add Faculty Account</a>
                                </li>
                                <li>
                                    <a href="dean-modify-faculty.php">Edit Faculty Account</a>
                                </li>
                                <li>
                                    <a href="dean-recover-faculty.php">Reset Faculty Account</a>
                                </li>
                            </ul>
                        </li> 
                        <li class="sidebar-item active ">
                            <a href="compile.php" class='sidebar-link' style="background-color: #e3e3e3">
                                <i data-feather="download" width="20"></i>
                                <span>Compile Attendance</span>
                            </a>
                        </li>
                    </ul>
                </div>
                    ...
                    <form class="row mb-4" action="dean-qrscanner.php" method="POST">
                        <div class="page-title">
                            <div class = 'row'>
                                ...
                                <div class = 'col-md-4'>
                                    <div class = 'row'>
                                        <div class = 'col-md-4'>
                                        <center><a href ='dean-schedule-viewer.php'>Attendance</a></center>
                                        </div>
                                        <div class = 'col-md-4'>
                                        <center><a href ='dean-qrscanner.php'><u>Start A Class</u></a></center>
                                        </div>
                                        <div class = 'col-md-4'>
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                ...
                                <div class="card-footer" style="background-color: #3365c1;">
                                    <input type="hidden" name="scannedqr" id="text" readonyy="" placeholder="scan qrcode" class="form-control">
                                    <center><p id="test1" style="color: #FFFFFF; position:relative; top:7px" ><strong>Scanning...</strong></p></center>
                                </div>
                            </div>
                        </div>
                        <div class = 'col-md-6'>
                                ...
                                <div class="card-body">
                                    <div class = 'row'>
                                        ...
                                        <center><div class ='col-md-4' style = 'width: 300px; position:relative; left:18px'>
                                            <div class = 'row'>
                                                <div class = 'col-md-6'>
                                                    <p style = "background-color: black; font-size:22px; font-weight:bold; color: #3365c1; border:solid; position:relative; top:8px; text-align:center"><span id="time"> </span></p>
                                                </div>
                                                <div class = 'col-md-6'>
                                                    <p style = "background-color: black; font-size:22px; font-weight:bold; color: #3365c1; border:solid; position:relative; top:8px; text-align:center"><?php echo date("m/d/Y"); ?></p>
                                                </div>
                                            </div>
                                        </div></center>
                                        <div class ='col-md-4'>
                            ...
                            <div class="card" style='height: 150px; position:relative;'>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class = 'row'>
                                        ...
                                        <div class = 'col-md-6'>
                                            <div class="clearfix">
                                                <input type="submit" name="verifystud" value="Select Student" class="btn btn-primary float-end">
                                            </div>
                                        </div>
                                    </div>
                                </div>
