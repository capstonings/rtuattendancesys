            ...
            <div class="main-content container-fluid">
				<section class="col-md-12">
                    ...
                    <center><div class="card" style = " width:100%">
                        <div class="card-header d-flex justify-content-between align-items-center" style="background-color: #3365c1; height:50px">
                            <div class = 'row'>
                                <div class = 'col-md-6'>
                                ...
                                <div class = 'col-md-6' style = 'position:relative; left: 950px; top:7px'>
                                    <p><a href='download-compilation.php' style ="color: #ffffff" >Download</a></p>
                                </div>
                            </div>
                        </div>
