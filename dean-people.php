                    ...
                    <div class = 'row'>
                        ...
                        <div class = 'col-md-4'>
                            <div class = 'row'>
                                ...
                                <div class = 'col-md-4'>
                                <center><a href ='dean-people.php'><u>People</u></a></center>
                                </div>
                            <div>
                        </div>
                        <div class = 'col-md-4'>
                    ...
                    <center><div class="card" style = " width:75%">
                        ...
                        <div class="card-body px-0 pb-0">
                            <div class="table-responsive">
                                <?php
                                    $sqlSelect = "SELECT * FROM courses_enrolled WHERE 
                                            subject1 = '" . $_SESSION['usubject'] 
                                    ...
                                    <table id="myTable" class="table table-bordered table-sm" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <?php endif ?>
                                                <?php if($mn == ''): ?>
                                                    <td><?php  echo $_SESSION['ln']; ?>, <?php  echo $_SESSION['fn']; ?> <?php  echo $mn; ?></td>
                                                <?php endif ?>
